...
var hljs = function () {
        ...
        var o = Object.freeze({
            __proto__: null,
            escapeHTML: r, inherit: a, nodeStream: e => {
                const t = [];
        ...
        const h = "[a-zA-Z]\\w*", f = "[a-zA-Z_]\\w*", p = "\\b\\d+(\\.\\d+)?",
            m = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", b = "\\b(0b[01]+)", x = {
        ...
        var k = Object.freeze({
                ...
                }, BACKSLASH_ESCAPE: x, APOS_STRING_MODE: E,
                QUOTE_STRING_MODE: v, PHRASAL_WORDS_MODE: _, COMMENT: w, C_LINE_COMMENT_MODE: N,
                C_BLOCK_COMMENT_MODE: y, HASH_COMMENT_MODE: R, NUMBER_MODE: {
                    className: "number",
                    begin: p, relevance: 0
        ...
        return (e => {
            const n = [], r = Object.create(null), a = Object.create(null), i = [];
            let o = !0
            ;const l = /(^(<[^>]+>|\t|)+|\n)/gm,
                c = "Could not find the language '{}', did you forget to load/include a language module?", u = {
                    disableAutodetect: !0, name: "Plain text", contains: []
                };
            let d = {
                noHighlightRe: /^(no-?highlight)$/i,
                languageDetectRe: /\blang(?:uage)?-([\w-]+)\b/i, classPrefix: "hljs-",
                tabReplace: null, useBR: !1, languages: null, __emitter: g
            };
            ...
            function p(e, t, n, a) {
                ...
                function u() {
                    null != y.subLanguage ? (() => {
                        ...
                        let t = y.keywordPatternRe.exec(M), n = "";
                        for (; t;) {
                ...
                function g(e) {
                    return e.className && k.openNode(_.classNameAliases[e.className] || e.className),
                        y = Object.create(e, {parent: {value: y}}), y
                }
                ...
                function b(e) {
                    const t = e[0], n = i.substr(e.index), s = h(y, e, n);
                    if (!s) return P;
                    const r = y
                ...
                try {
                    ...
                    return E(i.substr(A)), k.closeAllNodes(), k.finalize(), N = k.toHTML(), {
                        relevance: L, value: N, language: e, illegal: !1, emitter: k, top: y
                    }
                } catch (t) {
                    if (t.message && t.message.includes("Illegal")) return {
                        illegal: !0, illegalBy: {
                            msg: t.message, context: i.slice(A - 100, A + 100), mode: t.mode
                        }, sofar: N, relevance: 0,
                        value: I(i), emitter: k
                    };
                    if (o) return {
                        illegal: !1, relevance: 0, value: I(i), emitter: k,
                        language: e, top: y, errorRaised: t
                    };
                    throw t
                }
            }
            ...
            function m(e, t) {
                ...
                const n = (e => {
                    ...
                    })(e), s = t.filter(v).filter(w).map((t => p(t, e, !1)))
                ;s.unshift(n);
                const a = s.sort(((e, t) => {
            ...
            function x(e) {
                ...
                ;const s = t.textContent, r = n ? f(n, s, !0) : m(s), i = T(t);
                if (i.length) {
            ...
            Object.assign(e, {
                ...
                fixMarkup: e => (console.warn("fixMarkup is deprecated and will be removed entirely in v11.0"),
                    ...
                    e.useBR && (console.warn("'useBR' option is deprecated and will be removed entirely in v11.0"),
                        ...
                        d = S(d, e)
                }, initHighlighting: E, initHighlightingOnLoad: () => {
                ...
                autoDetection: w, inherit: S, addPlugin: e => {
                    i.push(e)
...
hljs.registerLanguage("swift", (() => {
    ...
    return e => {
        ...
        return t.contains = [s], {
            name: "Swift", keywords: i, contains: [a, e.C_LINE_COMMENT_MODE, n, {
                className: "type",
                begin: "\\b[A-Z][\\w\xc0-\u02b8']*[!?]"
            }, {
                className: "type",
    ...
    return e => {
        ...
        return {
            ...
            case_insensitive: !0, contains: [{
                ...
                keywords: {name: "script"}, contains: [m], starts: {
        ...
        return {
            ...
            contains: [e.COMMENT("^\\s*[!#]", "$"), {
                returnBegin: !0, variants: [{
                    begin: r + a,
                    relevance: 1
                }, {begin: r + "[ \\t\\f]+", relevance: 0}], contains: [{
                    className: "attr",
                    begin: r, endsParent: !0, relevance: 0
                }], starts: i
            }, {
                begin: s + t, returnBegin: !0,
